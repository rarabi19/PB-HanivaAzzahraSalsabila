...
public class SetelAlarm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bpengaturan.setOnClickListener(view -> {
            startActivity(new Intent(SetelAlarm.this, Pengaturan.class));
        });

        buser.setOnClickListener(view -> {
            startActivity(new Intent(SetelAlarm.this, Profile.class));
        });

        bhome.setOnClickListener(view -> {
            startActivity(new Intent(SetelAlarm.this, Home.class));
        });
