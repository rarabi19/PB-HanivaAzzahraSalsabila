...
public class Kalender extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bpengaturan.setOnClickListener(view -> {
            startActivity(new Intent(Kalender.this, Pengaturan.class));
        });

        buser.setOnClickListener(view -> {
            startActivity(new Intent(Kalender.this, Profile.class));
        });

        bhome.setOnClickListener(view -> {
            startActivity(new Intent(Kalender.this, Home.class));
        });
