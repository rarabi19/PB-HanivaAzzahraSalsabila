...
public class Kegiatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bpengaturan.setOnClickListener(view -> {
            startActivity(new Intent(Kegiatan.this, Pengaturan.class));
        });

        buser.setOnClickListener(view -> {
            startActivity(new Intent(Kegiatan.this, Profile.class));
        });

        bhome.setOnClickListener(view -> {
            startActivity(new Intent(Kegiatan.this, Home.class));
        });
